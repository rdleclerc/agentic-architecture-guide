...
Do not patch only the visible symptom. If the RCA cannot name the missing invariant, affordance, or feedback loop, label the change a mitigation and do not treat it as a durable fix.
